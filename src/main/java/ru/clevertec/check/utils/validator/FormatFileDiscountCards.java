...
public class FormatFileDiscountCards extends AbstractFormatValidator{
    ...
    protected boolean isValidFirstLine(String line) {
        ...
        return line.equals(StringConst.FIRST_LINE_FILE_DISCOUNT_CARD);
    }
    ...
    protected boolean isValidLine(String line) {
        ...
        return PatternConst.REGEX_DISCOUNT_CARD.matcher(line).matches();
    }
}
